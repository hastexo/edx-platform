...
AWS_S3_PORT = AUTH_TOKENS.get('AWS_S3_PORT')
AWS_S3_CALLING_FORMAT = AUTH_TOKENS.get('AWS_S3_CALLING_FORMAT')
AWS_S3_SECURE_URLS = AUTH_TOKENS.get('AWS_S3_SECURE_URLS')
AWS_S3_USE_SSL = AUTH_TOKENS.get('AWS_S3_USE_SSL')
AWS_AUTO_CREATE_BUCKET = AUTH_TOKENS.get('AWS_AUTO_CREATE_BUCKET', False)
...
BROKER_TRANSPORT_OPTIONS = ENV_TOKENS.get('CELERY_BROKER_TRANSPORT_OPTIONS', {})
